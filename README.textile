...
Reader Notifier has originally been made by Troels Bay, forked by canbuffi and now actively developed by Mike Godenzi and Claudio Marforio, independent developers living in Europe. Please donate if you enjoy and find the app useful.

h3. Some background

This is a fork of canbuffi's *Reader Notifier* on github (http://github.com/canbuffi) to push active development on the project. Like the original it is released under GPL.
